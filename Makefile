...
# Build and push habana-jupyter-1.11.0-ubi8-python-3.8 image to the registry
.PHONY: habana-jupyter-1.14.0-ubi8-python-3.8
habana-jupyter-1.14.0-ubi8-python-3.8: jupyter-datascience-ubi8-python-3.8
	$(call image,$@,habana/1.14.0/ubi8-python-3.8,$<)
